...
class Preferencias(QtWidgets.QWidget):
    def __init__(self):
        ...
        theme_label = QtWidgets.QLabel("Selecciona un tema:")
        self.theme_combo = QtWidgets.QComboBox()
        self.theme_combo.addItems(["Claro", "Oscuro", "Aerofrost", "Aerogreen", "Aeroorganic", "Aerosunset", "FrutigerDark"])
        ...
        # Conexiones de ejemplo (puedes implementar la lógica real después)
